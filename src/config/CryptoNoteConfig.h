...
const char     CRYPTONOTE_NAME[]                             = "RaspCoin";
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/skr33t/raspcoin";
const std::string LICENSE_URL                                = "https://github.com/skr33t/raspcoin/blob/master/LICENSE";
